...
export default class WebformBuilder extends Component {
 ...
 attachEditComponentControls(component, parent, isNew, original, ComponentClass) {
    ...
    const type = document.querySelector(".mb-2.formio-form-group.has-feedback.formio-component.formio-component-select.formio-component-selectRadio")
    
    const card = document.querySelector(".tab-component-tabs.nav.nav-tabs.card-header-tabs")
    const requ = document.querySelector(".form-check.checkbox")
    requ.classList.add('form-switch')
    const requie = document.querySelector(".form-check.checkbox.form-switch")
    ...
    const val = document.querySelector('.mb-2.formio-form-group.has-feedback.formio-component.formio-component-datagrid.formio-component-values');
    const la = document.querySelector('.mb-2.formio-form-group.has-feedback.formio-component.formio-component-textarea.formio-component-label');
     const selec = document.querySelector('.mb-2.formio-form-group.has-feedback.formio-component.formio-component-datagrid.formio-component-data.values')
    const wig = document.querySelector('.mb-2.formio-form-group.has-feedback.formio-component.formio-component-select.formio-component-widget')
    ...
    const firstColumn = document.querySelector(".col.component-edit-tabs.col-sm-6")
    const secondColumn = document.querySelector('.col.col-sm-6')
    const premiereligne = document.querySelector('.lead')
    const deu = document.querySelector('.float-end')
