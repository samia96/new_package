...
class TabsComponent extends NestedComponent_1.default {
    ...
    get schema() {
        ...
        const components = lodash_1.default.cloneDeep(this.component.components);
    ...
    init() {
        this.components = [];
        this.tabs = [];
        lodash_1.default.each(this.component.components, (tab, index) => {
            this.tabs[index] = [];
            // Initialize empty tabs.
            tab.components = tab.components || [];
            lodash_1.default.each(tab.components, (comp) => {
    ...
    setTab(index) {
        ...
        lodash_1.default.each(this.refs[this.tabKey], (tab) => {
        ...
        lodash_1.default.each(this.refs[this.tabLinkKey], (tabLink, tabIndex) => {
