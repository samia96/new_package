...
exports.default = [
    ...
    // },
    {
        ...
        calculateValue: (context) => {
            ...
            if (lodash_1.default.isEmpty(lodash_1.default.omit(context.data.widget, 'type')) ||
                lodash_1.default.isEmpty(lodash_1.default.omit(calculatedValue, 'type'))) {
                ...
                if (existWidget && !lodash_1.default.isEmpty(lodash_1.default.omit(existWidget, 'type')) && type === existWidget.type) {
                    return lodash_1.default.omit(existWidget, 'language');
                }
                else if (type) {
                    return lodash_1.default.omit(widgets_1.default[type].defaultSettings, 'language');
                }
            }
            return context.data.widget;
        },
